CREATE USER 'lucas'@'localhost' IDENTIFIED BY '12345';

GRANT ALL PRIVILEGES on * . * to 'lucas'@'localhost';

FLUSH PRIVILEGES;

/* Geração do banco de dados uvv */
CREATE DATABASE uvv;
...
ALTER TABLE funcionario COMMENT 'Tabela contendo informações de cada funcionario';

ALTER TABLE funcionario MODIFY COLUMN cpf CHAR(11) COMMENT 'Coluna contendo o cpf do funcionário';
...
ALTER TABLE funcionario MODIFY COLUMN sexo CHAR(1) COMMENT 'Coluna incluindo o sexo do funcionário';
...
ALTER TABLE dependente COMMENT 'Tabela contendo os dados do dependente';

ALTER TABLE dependente MODIFY COLUMN cpf_funcionario CHAR(11) COMMENT 'Coluna contendo o cpf do funcionário ';

ALTER TABLE dependente MODIFY COLUMN nome_dependente VARCHAR(15) COMMENT 'Coluna contendo o nome do dependente';

ALTER TABLE dependente MODIFY COLUMN sexo CHAR(1) COMMENT 'Coluna contendo o sexo do dependente';

ALTER TABLE dependente MODIFY COLUMN data_nascimento DATE COMMENT 'Coluna contendo a data de nascimento do dependente';

ALTER TABLE dependente MODIFY COLUMN parentesco VARCHAR(15) COMMENT 'Coluna contendo o parentesco do dependente';
...
ALTER TABLE departamento COMMENT 'Tabela contendo os dados do departamento ';

ALTER TABLE departamento MODIFY COLUMN numero_departamento INTEGER COMMENT 'Coluna contendo o número do departamento ';

ALTER TABLE departamento MODIFY COLUMN nome_departamento VARCHAR(15) COMMENT 'Coluna contendo o nome do departamento ';

ALTER TABLE departamento MODIFY COLUMN cpf_gerente CHAR(11) COMMENT 'Coluna contendo o cpf do gerente';

ALTER TABLE departamento MODIFY COLUMN data_inicio_gerente DATE COMMENT 'Coluna contendo a data de ínicio do gerente';
...
ALTER TABLE projeto COMMENT 'Tabela contendo os dados do projeto ';

ALTER TABLE projeto MODIFY COLUMN numero_projeto INTEGER COMMENT 'Coluna contendo o número do projeto  ';

ALTER TABLE projeto MODIFY COLUMN nome_projeto VARCHAR(15) COMMENT 'Coluna contendo o nome do projeto ';

ALTER TABLE projeto MODIFY COLUMN local_projeto VARCHAR(15) COMMENT 'Coluna contendo o local do projeto';

ALTER TABLE projeto MODIFY COLUMN numero_departamento INTEGER COMMENT 'Coluna contendo o número do departamento';

/* Geração do unique index no nome_projeto */
...
ALTER TABLE trabalha_em COMMENT 'Tabela contendo os dados de trabalha em';

ALTER TABLE trabalha_em MODIFY COLUMN cpf_funcionario CHAR(11) COMMENT 'Coluna contendo o cpf do funcionário ';

ALTER TABLE trabalha_em MODIFY COLUMN numero_projeto INTEGER COMMENT 'Coluna contendo o número do projeto';

ALTER TABLE trabalha_em MODIFY COLUMN horas DECIMAL(3, 1) COMMENT 'Coluna contendo o número de horas';
...
ALTER TABLE localizacoes_departamento COMMENT 'Tabela contendo as localizações do departamento ';

ALTER TABLE localizacoes_departamento MODIFY COLUMN numero_departamento INTEGER COMMENT 'Coluna contendo o número do departamento';

ALTER TABLE localizacoes_departamento MODIFY COLUMN local VARCHAR(15) COMMENT 'Coluna contendo o local do departamento  ';
...
/* O numero_projeto que é uma fk da tabela trabalha_em está referenciando a pk numero_projeto da tabela projeto */
...
/* Alteração do varchar(30) para o varchar(35) do atributo endereco da tabela funcionario */ 
ALTER TABLE funcionario
MODIFY endereco varchar(35);

/* Alteração do char(11) not null para o char(11) null do atributo cpf_supervisor da tabela funcionario */
ALTER TABLE funcionario
...
/* Alteração do decimal(3,1) not null para o decimal(3,1) null do atributo horas da tabela trabalha_em */
